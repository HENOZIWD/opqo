...
import { requestVerificationCode } from '../apis/requestVerificationCode';
import { PHONENUMBER_VALIDATION_DURATION_SECOND } from '../utils/constant';
import { signup } from '../apis/signup';
import { ERR_MSG_CONFIRMPASSWORD_NOTEQUAL, ERR_MSG_DUPLICATED_PHONENUMBER, ERR_MSG_EMPTY_PHONENUMBER, ERR_MSG_EMPTY_VERIFICATIONCODE, ERR_MSG_PASSWORD_RULE } from '../utils/message';
import { signupFormStyle } from '../styles/signupFormStyle.css';
